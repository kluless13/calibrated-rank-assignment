#!/usr/bin/env python3
"""Run a trained TAXDNA-style CNN checkpoint on open-candidate queries."""
...
from train_taxdna_cnn_baseline import TaxDnaCnn  # noqa: E402
...
def main() -> None:
    ...
    model = TaxDnaCnn(
        target_embed_dim=tree_embeddings.shape[1],
